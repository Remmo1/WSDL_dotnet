...
namespace WcfClient.ServiceReference1 {
    ...
    public interface ICalculator {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/FindPrimesBetween", ReplyAction="http://tempuri.org/ICalculator/FindPrimesBetweenResponse")]
        System.ValueTuple<int, int> FindPrimesBetween(int val1, int val2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/FindPrimesBetween", ReplyAction="http://tempuri.org/ICalculator/FindPrimesBetweenResponse")]
        System.Threading.Tasks.Task<System.ValueTuple<int, int>> FindPrimesBetweenAsync(int val1, int val2);
    }
    ...
    public partial class CalculatorClient : System.ServiceModel.ClientBase<WcfClient.ServiceReference2.ICalculator>, WcfClient.ServiceReference2.ICalculator {
        ...
        public System.ValueTuple<int, int> FindPrimesBetween(int val1, int val2) {
            return base.Channel.FindPrimesBetween(val1, val2);
        }
        
        public System.Threading.Tasks.Task<System.ValueTuple<int, int>> FindPrimesBetweenAsync(int val1, int val2) {
            return base.Channel.FindPrimesBetweenAsync(val1, val2);
        }
    }
}
